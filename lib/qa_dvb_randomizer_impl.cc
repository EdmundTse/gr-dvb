...
void qa_dvb_randomizer_pp::setUp() {}
void qa_dvb_randomizer_pp::tearDown() {}

void qa_dvb_randomizer_pp::lfsr_start_values()
{
 ...
 */
void qa_dvb_randomizer_pp::test_randomize_derandomize()
{
